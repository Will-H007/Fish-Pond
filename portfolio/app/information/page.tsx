...
const DoubleLinkedListLayout: React.FC = () => {
  ...
  return (
    <div className="h-screen flex gap-x-8 w-max-xl grid grid-rows-6 grid-cols-11 mx-10 mt-10 justify-center items-center">

      <div className="flex flex-wrap col-start-1 col-end-3 row-start-2 row-end-5 m-2 justify-center items-end h-full w-full">
